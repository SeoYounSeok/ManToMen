...
public class GetParticipateDatamore extends GetRequest {
    public GetParticipateDatamore(Activity activity) {
        super(activity);
    }
...
//        txtList.setAdapter(adapter);
    ...
    protected ArrayList<AllClass> getArrayListFromJSONString(String jsonString) {  //올클래스 어레이리스트 만들기
        ...
        ArrayList<AllClass> output = variableOfClass.getAllClass();  // 기존에 꺼에 추가!
