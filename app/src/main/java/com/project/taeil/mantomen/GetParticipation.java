...
public class GetParticipation extends GetRequest {
    public GetParticipation(Activity activity) {
        super(activity);
    }
    ...
    protected void onPreExecute() {
        ...
        try {
            url = new URL(serverURLStr + "/index/participation?value=" + userID);  // http://serverURLStr/get-data
